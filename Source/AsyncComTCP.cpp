...
// AsyncComToTCP.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CAsyncComTCPApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CAsyncComTCPApp

CAsyncComTCPApp::CAsyncComTCPApp()
{
...
// Единственный объект CAsyncComTCPApp

CAsyncComTCPApp theApp;


// Инициализация CAsyncComTCPApp

BOOL CAsyncComTCPApp::InitInstance()
{
